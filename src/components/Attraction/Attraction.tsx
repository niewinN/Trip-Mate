...
//   return (
//     <>
//     <div onClick={handleOpenModal} className={`${styles.attractionCard} ${isSelected && !disabledSelectedStyle ? styles.selected : ""}`}>
//       {/* Przycisk dodawania */}
//       {showAddButton && (
//         <button
...
//     {isModalOpen && (
//       <AttractionModal
//         attraction={{ title, description, thumbnail, rating, reviews_original, address }}
